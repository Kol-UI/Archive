Labs <- read.csv2("...2PBS-TP-BLANC.csv", sep=";")
...
barplot(table(Labs$P�tes),ylab="effectifs",xlab="pates",main="choix des pates")
pie(table(Labs$P�tes),ylab="effectifs",xlab="pates",main="choix des pates")
...
sort(table(Labs$P�tes),decreasing=TRUE)
...
#1.4 caract�re quandtitatifs continu#
...
#3.3#
chisq.test(table(Labs$P�tes,Labs$Couleur))
#khi-deux=xsquared#
#df=degr� de libert�#
#trouver talpha avec le tableau et comparer � khi-deux#
