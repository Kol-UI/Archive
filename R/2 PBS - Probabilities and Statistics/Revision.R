myData<-read.csv2("...2PBS-TP-BLANC.csv")
summary(myData)
...
#histogramme
barplot(table(myData$P�tes),ylab="effectifs",xlab="P�tes",main="Choix des p�tes")
#camembert
pie(table(myData$P�tes),main="Choix des p�tes")
#histogramme
...
plot(table(myData$Nombre), type = "h",ylab="effectifs",xlab="Nombres",main="Etude du caract�re nombre")
#moyenne
mean(myData$Nombre)
var(myData$Nombre)
#ecart-type
...
i<-seq(1,11)
#graphe
plot(i,prenomsCumul[,1],xlab="Nombre",ylab="effectifs cumules",col="blue",main="Effectifs cumul�s du caract�re nombre")
...
#Exercice 3.3
chisq.test(table(myData$P�tes,myData$Couleur))
